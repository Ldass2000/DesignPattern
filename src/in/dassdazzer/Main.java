package in.dassdazzer;

import app.Application;
import in.dassdazzer.factories.MacOSFactory;
import in.dassdazzer.factories.UIFactory;
import in.dassdazzer.factories.WindowsFactory;
 ...
 * Now you have to use factory when your application support different product families example
 *  Computer can be PC,Server or Assembled.
 * So what client needs to do is just pass the family of the product and that product will be built
 *  i.e. created.
 ...
 * 3.  Abstract factory - which helps for interacting for creation and product factories will extend
 *     that to ensure right product gets created. - Here UIFactory
